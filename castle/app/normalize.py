...
ALIAS = {
    "date": ["計上日", "営業日", "売上日", "勤務日", "棚卸日", "年月日", "日付", "date"],
    "code": ["部門コード", "組織コード", "部署コード", "コード", "code"],
    "dept": ["部門名", "組織名", "部署名", "部門", "組織", "部署", "所属", "department", "dept"],
    "amount": ["売上金額", "純売上高", "売上高", "販売金額", "売上", "残高", "金額", "sales", "amount"],
    "hours": ["実労働時間", "総労働時間", "就業時間", "労働時間", "人時", "hours"],
    "cost": ["売上原価", "仕入原価", "原価", "cost"],
    "buy": ["仕入金額", "仕入高", "仕入額", "purchase"],
    "stock": ["在庫金額", "棚卸金額", "在庫高", "在庫", "stock", "inventory"],
    # 科目は部門ではない。対応表を引かず、書いてあるものをそのまま主語にする列
    "account": ["勘定科目", "科目名", "科目", "account"],
